...
const MobileNav = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 small:hidden glass safe-area-bottom">
        ...
        {tabs.map((tab) => {
          ...
          return (
            <LocalizedClientLink
              key={tab.href}
              href={tab.href}
              className={`flex flex-col items-center gap-0.5 px-3 py-1 transition-colors ${isActive ? "text-rose-400" : ""}`}
